...
class MainActivity : AppCompatActivity() {
    ...
    private val onNewMessage = Emitter.Listener { args ->
        if (App.prefs.isLoggedIn) {
            runOnUiThread {
                val channeldId = args[2] as String
                if(channeldId == selectedChannel?.id) {
                    ...
                    val newMessage = Message(msgBody, userName, channeldId, userAvatar, userAvatarColor, id, timeStamp)
